  ...
  Widget build(BuildContext context) {
    ...
    final creditos = [
      ...
      },
      {
        ...
        'url':
            'https://www.flaticon.es/icono-gratis/boleto_1061702?related_id=1061651&origin=search',
      },
      {
        'icon': 'assets/icons/helpIconBW.png',
        'descripcion': 'Icono de Ayuda creado por Freepik',
        'url':
            'https://www.flaticon.es/icono-gratis/ayudar_1660114?term=ayuda&related_id=1660114',
      },
      {
        'icon': 'assets/icons/eventsIconBW.png',
        'descripcion': 'Icono de Eventos creado por Uniconlabs',
        'url':
            'https://www.flaticon.es/icono-gratis/calendario_5656173?related_id=5656087&origin=search',
      },
      {
        'icon': 'assets/icons/pastEventsIconBW.png',
        'descripcion': 'Icono de Anteriores Eventos creado por Uniconlabs',
        'url':
            'https://www.flaticon.es/icono-gratis/planificador_5656086?related_id=5656049&origin=search',
      },
      {
        'icon': 'assets/icons/futureEventsIconBW.png',
        'descripcion': 'Icono de Próximos Eventos creado por Uniconlabs',
        'url':
            'https://www.flaticon.es/icono-gratis/calendario_5656690?related_id=5656753&origin=search',
      },
      {
        'icon': 'assets/icons/contactIconBW.png',
        'descripcion': 'Icono de Contacto creado por pojok d',
        'url':
            'https://www.flaticon.es/icono-gratis/contact-us_9194860?related_id=9194848&origin=search',
      },
      {
        'icon': 'assets/icons/infoIconBW.png',
        'descripcion': 'Icono de Información creado por Mehwish',
        'url':
            'https://www.flaticon.es/icono-gratis/lista_6593003?related_id=6593002&origin=search',
      },
      {
        'icon': 'assets/icons/refreshIconBW.png',
        'descripcion': 'Icono de Recargar creado por mavadee',
        'url':
            'https://www.flaticon.es/icono-gratis/recargar_3580303?related_id=3580304&origin=search',
      },
      {
        'icon': 'assets/icons/newsIconBW.png',
        'descripcion': 'Icono de Noticias creado por Freepik',
        'url':
            'https://www.flaticon.es/icono-gratis/periodico_2965851?related_id=2965879&origin=search',
      },
      {
            ...
            RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  const TextSpan(
                    text:
                        'Todos los iconos que aparecen a continuación han sido utilizados de acuerdo con los ',
                  ),
                  TextSpan(
