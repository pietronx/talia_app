...
class WidgetsUtil {
  ...
  static Widget tarjetaAnteriorEvento({
    ...
    return GestureDetector(
      // Al pulsar la tarjeta se abre el modal con detalles
      onTap: () {
      ...
      child: Column(
        ...
        children: [
          FutureBuilder<Image>(
            // Carga la imagen desde el enlace de vista previa (Google Drive)
    ...
    return FutureBuilder<Image>(
      ...
      builder: (context, snapshot) {
        ...
        return Card(
          ...
          color: Colors.white,
          child: InkWell(
            // Si hay un enlace, lo abre al tocar
            onTap: () {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        noticia.descripcion.length > 280
                            ? '${noticia.descripcion.substring(0, 280)}...'
                            : noticia.descripcion,
                        style: TextStyle(
                          fontSize: descriptionFontSize,
